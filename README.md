...
**Cost Engineer**  
_Period:_ 2024.01 to Date  

Various PV Construction Projects  
_Location:_ Chile and Colombia  
My Team: Remote supervision on 1 engineer in Colombia, 3 jr. engineers in Chile.  
**Description:**  
...
_Period:_ 2017.09 to 2019.02  
**Description:**  
Participated in site reconnaissance, problem analysis, modeling, and project design. Handled cost estimation, proposal development, resource mobilization, and contract management. Attended flagship contractual issues.

Projects:  
- Assisted Natural-Secondary Ventilation System for Spence Electrowinning Plant of **BHP Billiton**.
- Supply of Acid Mist Control Systems for Escondida Electrowinning Plant of **BHP Billiton**.
...
**Technical Unit Manager**  
_Period:_ 2015.03 to 2017.07  
**Projects:**
- Construction of Hydropower Plant Intake for **Generadora HidroÑuble**. San Fabián de Alico, Chile (US$ ~5 million)
- Slope Stabilization in Route-5 Highway for **Ferrovial**. Angostura, Chile (US$ ~1 million)
- Excavation and Stabilization of Metro Interconnection Tunnel for Metro Franklin for **Ferrovial**. Santiago, Chile (US$ ~2 million)  
**Description:**  
...
_Period:_ 2009.02 to 2010.03  
**Projects:**  
- Tunnel stabilization with shotcrete for Carmen and Margarita Mines, **Minera Las Cenizas**. Cabildo, Chile  
- Tunnel excavation and stabilization for Papomono Mine, **Minera Vale**. Illapel, Chile  
- Slope stabilization in Los Pelambres Facilities, **Antofagasta Minerals**. Salamanca, Illapel  
- **Description:**  
...
_Period:_ 2009.03 to 2011.12  
- **Institution:** [University of La Serena](http://admision.userena.cl/media/attachments/2023/09/29/25017_ingenieria_de_minas.pdf)  
...
_Period:_ 2023.03 to 2023.08  
- **Institution:** [MIT Schwartman College of Computing](https://verify.mygreatlearning.com/verify/HAZXISXQ)  
- **Description:**  
...
- **Institution:** [Fraunhofer Institute of Advanced Research](https://www.research-in-germany.org/energinno/recent-campaigns/innomine-chile0.html)  
- **Location:** Santiago, Chile. Various locations in Germany.  
- **Description:**  
...
- **Institution:** [Akademia Gornizco Hurnitza](https://www.agh.edu.pl/en)  
...
- **Institution:** University of Castilla-La Mancha (Spain) & University of La Serena (Chile)  
- **Location:** Punitaque, Región de Coquimbo. Chile  
- **Description:**  
Learned design and execution of sampling campaigns, using Kriging Method to unveil hidden patterns in stream sediments. Demonstrated that concentrations of heavy metals in the region are controlled by geological formations rather than mining activity.
